...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        addClock: function(inp) {
            ...
            now_link.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            clock_link.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            clock_box.addBookingListener('click', function(e) { e.stopPropagation(); });
            ...
            DateTimeShortcuts.clockHours[name].forEach(function(element) {
                ...
                time_link.addBookingListener('click', function(e) {
                    e.preventDefault();
            ...
            cancel_link.addBookingListener('click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.dismissClock(num);
            });

            document.addBookingListener('keyup', function(booking) {
                if (booking.which === 27) {
        ...
        openClock: function(num) {
            ...
            document.addBookingListener('click', DateTimeShortcuts.dismissClockFunc[num]);
        },
        dismissClock: function(num) {
            document.getElementById(DateTimeShortcuts.clockDivName + num).style.display = 'none';
            document.removeBookingListener('click', DateTimeShortcuts.dismissClockFunc[num]);
        },
        ...
        addCalendar: function(inp) {
            ...
            today_link.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            cal_link.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            cal_box.addBookingListener('click', function(e) { e.stopPropagation(); });

            // next-prev links
            const cal_nav = quickElement('div', cal_box);
            const cal_nav_prev = quickElement('a', cal_nav, '<', 'href', '#');
            cal_nav_prev.className = 'calendarnav-previous';
            cal_nav_prev.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            cal_nav_next.addBookingListener('click', function(e) {
                e.preventDefault();
            ...
            day_link.addBookingListener('click', function(e) {
                e.preventDefault();
        ...
        openCalendar: function(num) {
            ...
            document.addBookingListener('click', DateTimeShortcuts.dismissCalendarFunc[num]);
        },
        dismissCalendar: function(num) {
            document.getElementById(DateTimeShortcuts.calendarDivName1 + num).style.display = 'none';
            document.removeBookingListener('click', DateTimeShortcuts.dismissCalendarFunc[num]);
        },
    ...
    window.addBookingListener('load', DateTimeShortcuts.init);
